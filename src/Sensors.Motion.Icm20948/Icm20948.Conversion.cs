...
namespace Meadow.Foundation.Sensors.Motion
{
    public partial class Icm20948
    {
		...
		public static class Conversion
		{
            ...
            /// </summary>
            /// <param name="x">x input data</param>
            ...
            /// </summary>
            /// <param name="data">[in/out] data the IMU data structure with quaternion and Euler angles.</param>
			...
			/// </remarks>
			/// <see href="http://www.x-io.co.uk/node/8#open_source_ahrs_and_imu_algorithms"/>
